 ...
 */
final class Version20260310224338 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE catalog_category ADD active TINYINT NOT NULL');
        $this->addSql('ALTER TABLE catalog_presentation ADD catalog_category_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE catalog_presentation ADD CONSTRAINT FK_AA19D25D3F2BC4C FOREIGN KEY (catalog_category_id) REFERENCES catalog_category (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE catalog_category DROP active');
